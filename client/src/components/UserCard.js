...
function UserCard({ wallpaper, image, username, age, location, isOnline }) {
   ...
   return (
      <div
         ...
         className='w-full group gap-1 md:ga-3 min-h-[200px] max-w-[200px] relative rounded-2xl overflow-hidden hover:shadow-lg hover:shadow-warning duration-300 cursor-pointer'
      >
         <div
            className={
               !isOnline
